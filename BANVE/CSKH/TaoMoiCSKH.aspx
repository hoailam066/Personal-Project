<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/Style.master" AutoEventWireup="true" CodeFile="TaoMoiCSKH.aspx.cs" Inherits="CSKH_TaoMoiCSKH" %>
...
<div class="divLeft">
    ...
    <div class="divIFrame">
        <iframe id="container" name="container" src='<%# ViewState["TenTrang"].ToString() %>' style=" width:100%; height:100%" ></iframe>
    </div>
