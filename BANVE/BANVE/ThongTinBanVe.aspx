<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ThongTinBanVe.aspx.cs" Inherits="BANVE_ThongTinTuyenXe" %>
...
<head runat="server">
    ...
    <link href="../CSS/ThongTinBanVe.css" rel="stylesheet" />
                ...
                <div class="divCha box">
                    ...
                    <div class="divDong1">
                        ...
                        <div class="divConTrolGiaVe">
                            <asp:TextBox CssClass="txt" runat="server" ID="txtDaChon" Width="100%"></asp:TextBox>
                    ...
                    <div class="divDong1">
                        ...
                        <div class="divConTrolGiaVe">
                            <asp:TextBox CssClass="txt" runat="server" ID="txtGiaVe" Width="100%"></asp:TextBox>
                        </div>
                        <div class="divGhe">
                    ...
                    <div class="divDong1 ">
                        <asp:CheckBox runat="server" ID="chkDaThanhToa" Text="Đã thanh toán" />
                    </div>
                    <div class="divDong1">
                        <asp:CheckBox runat="server" ID="chkVeKThuTien" Text="Vé không thu tiền" />
