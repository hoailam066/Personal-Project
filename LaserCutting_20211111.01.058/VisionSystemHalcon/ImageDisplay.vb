...
#Region "Member"
    ...
    Public ReadOnly Property ImageX As Integer
        Get
            Try
                Return HWindowControl1.ImagePart.Width
            Catch ex As Exception
                Return 0
            End Try
        End Get
    ...
    Public ReadOnly Property ImageY As Integer
        Get
            Try
                Return HWindowControl1.ImagePart.Height
            Catch ex As Exception
                Return 0
            End Try
        End Get
...
#Region "Property"
    ...
    Public Property Record As Boolean
        ...
        End Get
        Set(ByVal value As Boolean)
            'If Not (m_pVideoOutNew = Nothing) Then
            '    Emgu.CV.CvInvoke.cvReleaseVideoWriter(m_pVideoOutNew)
            '    m_pVideoOutNew = Nothing
            'End If
            'Dim m_VideoSize As System.Drawing.Size
            'm_VideoSize.Width = CInt(Width)
            'm_VideoSize.Height = CInt(Height)

            'Dim fourcc As Integer = Emgu.CV.CvInvoke.CV_FOURCC(CChar("X"), CChar("V"), CChar("I"), CChar("D")) 'c (((c1) & 255) + (((c2) & 255) << 8) + (((c3) & 255) << 16) + (((c4) & 255) << 24))
            'm_pVideoOutNew = Emgu.CV.CvInvoke.cvCreateVideoWriter("", fourcc, 10.0, m_VideoSize, 1)
            If value = True Then
                m_Record = value
            End If
        End Set
...
#Region "Events"
    ...
    Public Event ImageDisplay_MouseDown2(ByVal Location As System.Drawing.PointF, ByVal e As Windows.Forms.MouseEventArgs)
    Public Event ImageDisplay_MouseMove(ByVal X As Double, ByVal Y As Double)
    Public Event ImageDisplay_MouseMove2(ByVal Location As System.Drawing.PointF, ByVal e As Windows.Forms.MouseEventArgs)
    Public Event ImageDisplay_MouseUp(ByVal X As Double, ByVal Y As Double)
    Public Event ImageDisplay_MouseUp2(ByVal Location As System.Drawing.PointF, ByVal e As Windows.Forms.MouseEventArgs)
...
#End Region
    ...
    Private Sub HWindowControl1_HMouseDown_1(ByVal sender As System.Object, ByVal e As HalconDotNet.HMouseEventArgs) Handles HWindowControl1.HMouseDown
        If e.Button = Windows.Forms.MouseButtons.Left Then
            ...
            End If
        End If
        RaiseEvent ImageDisplay_MouseDown2(New System.Drawing.PointF(CSng(e.X), CSng(e.Y)), New Windows.Forms.MouseEventArgs(e.Button, e.Clicks, CInt(e.X * HWindowControl1.Width / HWindowControl1.ImagePart.Width), CInt(e.Y * HWindowControl1.Height / HWindowControl1.ImagePart.Height), e.Delta))
    End Sub
    ...
    Private Sub HWindowControl1_HMouseMove_1(ByVal sender As System.Object, ByVal e As HalconDotNet.HMouseEventArgs) Handles HWindowControl1.HMouseMove
        RaiseEvent ImageDisplay_MouseMove2(New System.Drawing.PointF(CSng(e.X), CSng(e.Y)), New Windows.Forms.MouseEventArgs(e.Button, e.Clicks, CInt(e.X * HWindowControl1.Width / HWindowControl1.ImagePart.Width), CInt(e.Y * HWindowControl1.Height / HWindowControl1.ImagePart.Height), e.Delta))
    End Sub
    ...
    Private Sub HWindowControl1_HMouseUp_1(ByVal sender As System.Object, ByVal e As HalconDotNet.HMouseEventArgs) Handles HWindowControl1.HMouseUp
        RaiseEvent ImageDisplay_MouseUp2(New System.Drawing.PointF(CSng(e.X), CSng(e.Y)), New Windows.Forms.MouseEventArgs(e.Button, e.Clicks, CInt(e.X * HWindowControl1.Width / HWindowControl1.ImagePart.Width), CInt(e.Y * HWindowControl1.Height / HWindowControl1.ImagePart.Height), e.Delta))
    End Sub
