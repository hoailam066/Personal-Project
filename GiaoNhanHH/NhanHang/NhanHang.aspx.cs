...
public partial class HangHoa_HangDi : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.Url.Query == "")
            Response.Redirect(Request.Url.AbsoluteUri + "?tab=nhanhang");
        //Load Quyền
        DataTable dt = new DataTable();
        dt.Columns.Add("TenTrang", typeof(string));
        dt.Columns.Add("TenQuyen", typeof(string));
        dt.Columns.Add("Icon", typeof(string));
        dt.Rows.Add(new object[] { "../NhanHang/TaoPhieuNhanHang.aspx", "Tạo phiếu nhận hàng", "../Image/iconphieunhanhang.png" });
        ...
        ViewState.Add("TenTrang", "../NhanHang/TaoPhieuNhanHang.aspx");
