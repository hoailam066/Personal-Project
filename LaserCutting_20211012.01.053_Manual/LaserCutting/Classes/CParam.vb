...
Public Class CVariableLaser
    ...
    Public Property UseScale As Integer
        Get
            Return m_UseScale
        End Get
        Set(ByVal value As Integer)
        ...
        Try
            ...
            If Microsoft.VisualBasic.FileIO.FileSystem.FileExists(FilePath) Then
                ...
                With m_Variable.Laser
                    ...
                    If CXmler.GetXmlData(stemNode, "MCS_VARIABLE_LASER_UseScale", 0, rtnText) Then .UseScale = CInt(rtnText)
                End With
                ...
                With m_Variable.Graphic
                    ...
                    If CXmler.GetXmlData(stemNode, "MCS_VARIABLE_GRAPHIC_OFFSETX", 0, rtnText) Then .OffsetX = CInt(rtnText)
                    If CXmler.GetXmlData(stemNode, "MCS_VARIABLE_GRAPHIC_OFFSETY", 0, rtnText) Then .OffsetY = CInt(rtnText)
                    .LineColor = Color.Green
                    If CXmler.GetXmlData(stemNode, "MCS_VARIABLE_GRAPHIC_LINECOLOR", 0, rtnText) Then .LineColor = Color.FromArgb(CInt(rtnText))
                End With
    ...
    Public Function WriteDataToFile(ByVal FilePath As String) As Boolean
        ...
        Try
            ...
            With m_Variable.Laser
                ...
                Call CXmler.NewXmlValue(stemNode, "MCS_VARIABLE_LASER_UseScale", 0, .UseScale)
            End With
            ...
            With m_Variable.Graphic
                ...
                Call CXmler.NewXmlValue(stemNode, "MCS_VARIABLE_GRAPHIC_LINECOLOR", 0, .LineColor.ToArgb())
            End With
            With m_Variable.IO
