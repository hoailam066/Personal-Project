...
Public Class CLineCtrl
    ...
    Public Property Line As CLine
        ...
        Set(ByVal value As CLine)
            m_Line = value
            Me.m_StartX = m_Line.StartXPX
            Me.m_StartY = m_Line.StartYPX
            Me.m_EndX = m_Line.EndXPX
            Me.m_EndY = m_Line.EndYPX
    ...
    Protected Sub UpdateData()
        ...
        g.DrawLine(pen, New PointF(StartX, StartY), New PointF(EndX, EndY))
        ...
        If (minY < 0) Then
            minY = 0
        End If
        If (maxX > Me.Size.Width) Then
            maxX = Me.Size.Width
        End If
        If (maxY > Me.Size.Height) Then
            maxY = Me.Size.Height
        End If
