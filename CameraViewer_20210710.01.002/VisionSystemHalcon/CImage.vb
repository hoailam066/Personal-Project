...
Public Interface IImage
    ...
    Sub WriteImage(ByVal fileName As String, ByVal fileformat As String)
End Interface
...
#Region "Methods"
    ...
    ''' <param name="fileName"></param>
    ''' <remarks></remarks>
    Public Sub WriteImage(ByVal fileName As String, ByVal fileformat As String) Implements IImage.WriteImage
        Try
            Call m_BasedImage.WriteImage(fileformat, 0, fileName)
        Catch ex As Exception
            'Dim errCode As String
            'errCode = ex.Message.Replace("HALCON", "")
            'Call MsgBox(errCode, MsgBoxStyle.Critical, "CImage->WriteImage")
